package org.example.cms.service.impl;
...
public class SimpleCustomerServiceImpl implements CustomerService {
    ...
    static {
        customers = asList(
                new Customer(autoIncreaseId++, "Le Thi Chau", "chau.le@codegym.vn", "Ha Noi"),
                new Customer(autoIncreaseId++, "Nguyen Khac Nhat", "nhat@codegym.vn", "Quang Tri"),
                new Customer(autoIncreaseId++, "Nguyen Minh Trang", "trang@codegym.vn", "Ha Noi"),
                new Customer(autoIncreaseId++, "Nguyen Thuy Duong", "duong.nguyen@codegym.vn", "Sai Gon"),
